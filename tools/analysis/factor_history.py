...
TOP_SIGNAL_WEIGHTS: dict[str, int] = {
    # 买卖点 (2026-08-01 调: 2卖 4→6, 3卖 2→3)
    "sell_1卖⭐":             10,
    "sell_1卖":                7,
    "sell_2卖":                6,   # 4→6, 趋势股更常见 2 卖
    "sell_3卖":                3,   # 2→3
    # 威科夫子事件
    "wy_DistributionStart":    6,
    "wy_UTAD":                 8,   # 2026-08-05: 6→8, 主升浪背景最强逃顶 (60% 胜率, README 5.2)
    "wy_EVR":                  1,   # 2026-08-01: 3→1, 60m 状态型信号跨天重复, 不抢戏
    "wy_LPSY":                 4,
    "wy_SOW":                  4,
    # 背驰 (2026-08-01 调: 背驰权重全部降低, 因为滞后+触发少)
    "bc_日线趋势顶背":          5,   # 6→5
    "bc_日线普通顶背":          3,   # 4→3
    "bc_日线盘整顶背":          1,   # 2→1
    "bc_周线趋势顶背":          6,   # 8→6
    ...
    "bc_60m普通顶背":           2,   # 3→2
    "bc_60m盘整顶背":           1,   # 保持
    # 中枢 (2026-08-01 调: 跌出中枢 5→7, 真正的破位)
    "hub_跌进中枢":             3,
...
BOTTOM_SIGNAL_WEIGHTS: dict[str, int] = {
    # 买卖点 (2026-08-01 调: 2买 4→6, 3买 2→3, 镜像 TOP)
    "buy_1买⭐":             10,
    "buy_1买":                7,
    "buy_2买":                6,   # 4→6
    "buy_3买":                3,   # 2→3
