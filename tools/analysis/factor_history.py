...
TOP_SIGNAL_WEIGHTS: dict[str, int] = {
    # 买卖点 (2026-08-20 调: 2卖 6→4, 3卖 3→1, 按 8-19 14:40 bt_top.log 胜率 77%/70% 弱)
    "sell_1卖⭐":             10,
    "sell_1卖":                7,
    "sell_2卖":                4,   # 2026-08-20: 6→4, 8-19 14:40 bt_top.log 胜率 77.3% 弱
    "sell_3卖":                1,   # 2026-08-20: 3→1, 8-19 14:40 bt_top.log 胜率 69.9% 极弱
    # 威科夫子事件
    ...
    # 背驰 (2026-08-20 调: 周线趋势顶背 6→8, 普通 4→3, 盘整 1→4)
    "bc_日线趋势顶背":          5,   # 6→5
    "bc_日线普通顶背":          3,   # 4→3
    "bc_日线盘整顶背":          1,   # 2→1
    "bc_周线趋势顶背":          8,   # 2026-08-20: 6→8, 8-19 14:40 ⭐trend 顶 胜率 86.9% (551 触发)
    "bc_周线普通顶背":          3,   # 2026-08-20: 4→3, 8-19 14:40 79.1% 弱
...
BOTTOM_SIGNAL_WEIGHTS: dict[str, int] = {
    ...
    # 威科夫底部子事件 (2026-08-20 调: LPS 5→8 极强, SOS/SC/Compression 弱)
    "wy_Spring":              6,
